      ...
      <Row gutter={[24, 24]} className="mt-6">
          ...
          <Row gutter={[0, 24]}>
            ...
            <Col span={24}>
              <Card className="text-center rounded-xl shadow-sm">
                ...
                <Text type="secondary">
                  Connect by phone for assistance or urgent matters during office hours.
                </Text>
                <br />
                <Text strong style={{ color: "#4f46e5" }}>
                  +251 0000-0000
            ...
            <Col span={24}>
              <Card className="text-center rounded-xl shadow-sm">
                <EnvironmentOutlined style={{ fontSize: 30, color: "#4f46e5" }} />
                <Title level={4} className="mt-3">
                  Visit Us
                </Title>
                <Text type="secondary">
                  Come to our main office during business hours for in-person support.
                </Text>
                <br />
                <Text strong style={{ color: "#4f46e5" }}>AA, Ethiopia</Text>
              </Card>
            </Col>
          </Row>
        </Col>
        ...
        <Col xs={24} md={14}>
          <Card className="rounded-2xl shadow-md">
            ...
            <Form layout="vertical" form={form} onFinish={onFinish} className="mt-10">
              <Row gutter={16}>
                <Col span={12}>
                  <Form.Item
                    name="fullName"
