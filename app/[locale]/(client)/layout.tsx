...
import AccountDropdown from "@/app/[locale]/admin/components/layout/AccountDropdown";
import {
  adminMenus,
  menuItems,
} from "@/app/[locale]/admin/components/layout/menus";
import RenderMenuItem from "@/app/[locale]/admin/components/layout/RenderMenuItem";
  ...
  return (
    <Layout>
      ...
      <Drawer
        ...
        extra={
          <Space>
            <Button type="link" onClick={() => onClickDrawer(false)}>
              Close
            </Button>
          </Space>
        }
      ...
      <Layout>
        <Header style={headerStyle} className="flex justify-between">
          <div className="flex flex-row justify-between">
            ...
            <div className="pl-4 md:block">{/* TODO Add Action Button */}</div>
          </div>
